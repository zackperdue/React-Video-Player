  ...
  render: function(){
    ...
    return (
      React.createElement("div", {className: "video_player"}, 
        ...
        React.createElement("div", {className: "control_bar"}, 
          ...
          React.createElement("button", {onClick: this.toggleVolume}, React.createElement("i", {className: "icon-volume-medium"})), 
          React.createElement("button", {onClick: this.toggleFullscreen}, React.createElement("i", {className: "icon-fullscreen"})), 
          React.createElement("div", {className: "progress_bar"}, 
            React.createElement("div", {className: "played"}, 
              React.createElement("button", {className: "seeker"})
            ), 
