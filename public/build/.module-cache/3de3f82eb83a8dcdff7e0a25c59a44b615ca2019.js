    ...
    return (
      React.createElement("div", {className: "video_player"}, 
        ...
        React.createElement("div", null, 
          React.createElement("button", null, React.createElement("i", {className: "icon-play"})), 
          React.createElement("button", null, React.createElement("i", {className: "icon-volume-high"}))
